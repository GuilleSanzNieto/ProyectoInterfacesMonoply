...
const propiedades = [
  ...
  { index: 37, name: "Teleco", price: 520 },
...
const Tablero = () => {
  ...
  const casillaNames = [
    ...
    "Comunicación",
    <img src={suerte} alt="Suerte" style={{ width: "60%", transform: 'rotate(90deg)' }} />,
    "Filosofía",
    "Derecho",
    <img src={metro} alt="Metro" style={{ width: "60%", transform: 'rotate(90deg)' }} />,
    "Educación",
    <img src={juego} alt="Juego" style={{ width: "60%", transform: 'rotate(90deg)' }} />,
    "Ciencias",
    "Medicina",
    <img src={google} alt="Google" style={{ width: "75%" }} />,
    "Turismo",
    <img src={juego} alt="Juego" style={{ width: "75%" ,transform: 'rotate(180deg)'}} />,
    "Estudios sociales",
    "Comercio",
    <img src={metro} alt="Metro" style={{ width: "75%"  ,transform: 'rotate(180deg)'}} />,
    "Ciencias de la salud",
    "Psicología",
    <img src={suerte} alt="Suerte" style={{ width: "85%"  ,transform: 'rotate(180deg)'}} />,
    "Industriales",
    "Go to prision",
    "Bellas artes",
    "Económicas",
    <img src={juego} alt="Juego" style={{ width: "55%", transform: 'rotate(270deg)' }} />,
    "Arquitectura",
    <img src={metro} alt="Metro" style={{ width: "60%", transform: 'rotate(270deg)'}} />,
    <img src={suerte} alt="Suerte" style={{ width: "60%", transform: 'rotate(270deg)' }} />,
    "Teleco",
    <img src={juego} alt="Juego" style={{ width: "55%", transform: 'rotate(270deg)' }} />,
    "ETSII",
